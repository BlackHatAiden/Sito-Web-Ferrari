...
<html>
    ...
    <body>
        ...
        <div class="container-fluid" style=" padding-left: 0; padding-right: 0;">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown" >
                                        ...
                                        <?php
                                            ...
                                            else
                                            {
                                                ...
                                                echo '<li><a class="dropdown-item" href="index.php">Gestione Account</a></li>';
                                            }
            ...
            <!--Form Cambio Informazioni -->
            <form action="inputGestione.php" method="POST" name="formRegistrazione" class="form-box px-3" >
                ...
                <div class="row" >
                        ...
                        <div class="col-sm-12 col-md-12 text-center ">
                            ...
                            <!--Tutte le informazioni che prendo dal db sull'utente-->
                            <?php
                                ...
                                //creazione query
                                $e = "'".$_SESSION['email']."'" ;
                                $query = 'select * from public."Utente" where(email = '.$e.')';
                                ...
                                //stampo varie informazioni
                                echo '<div class="col-sm-12 col-md-12 text-center "><Strong>Email</Strong>: '.$row['email'].'</div>' ;

                                echo '<div class="col-sm-12 col-md-12 text-center "><Strong>Nome</Strong>: '.$row['nome'].'</div>' ;

                                echo '<div class="col-sm-12 col-md-12 text-center "><Strong>Cognome</Strong>: '.$row['cognome'].'</div>' ;

                                echo '<div class="col-sm-12 col-md-12 text-center "><Strong>Sesso</Strong>: '.$row['sesso'].'</div>' ;

                                echo '<div class="col-sm-12 col-md-12 text-center "><Strong>Data di nascita</Strong>: '.$row['data nascita'].'</div>' ;

                                echo '<div class="col-sm-12 col-md-12 text-center "><Strong>Lavoro</Strong>: '.$row['lavoro'].'</div>' ;

                                echo '<div class="col-sm-12 col-md-12 text-center "><Strong>Via</Strong>: '.$row['via'].'</div>' ;

                                echo '<div class="col-sm-12 col-md-12 text-center "><Strong>Cap</Strong>: '.$row['cap'].'</div>' ;

                                echo '<div class="col-sm-12 col-md-12 text-center "><Strong>Nazionalità</Strong>: '.$row['nazionalita'].'</div>' ;

                                echo '<div class="col-sm-12 col-md-12 text-center "><Strong>Password</Strong>: '.$row['password'].'</div>' ;
                        ...
                        <div class="col-sm-12 col-md-12 text-center ">
                            ...
                            <Strong>Informazioni che possono essere cambiate</Strong>
                        ...
                        <div class="col-sm-12 col-md-12 text-center ">
                            ...
                            <div class="form-input">
                                ...
                                <input name="Via" type="text"  placeholder="Indirizzo di fatturazione"  >
                        ...
                        <div class="col-sm-12 col-md-12 text-center ">
                            ...
                            <div class="form-input">
                                ...
                                <input name="Cap" type="text" id="capForm" placeholder="CAP" >
                        ...
                        <!--sezione a comparsa -->
                        <div class="col-sm-12 col-md-12 text-center" id="capLN" >
                        ...
                        <div class="col-sm-12 col-md-12 text-center ">
                            ...
                            <button name="changeButton"  type="submit" class="btn btn-block text-uppercase" onsubmit="return controllaCap();" >
                                Cambia
                            </button>
