...
<html>
    ...
    <body>
        ...
        <div class="container-fluid" style=" padding-left: 0; padding-right: 0;">
                        ...
                        <ul class="navbar-nav  mx-auto" >
                                    ...
                                    <li class="nav-item dropdown mx-5"  >
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown" >
                                            ...
                                            <li><a class="dropdown-item" href="index.php" >SF21</a></li>
            ...
            <!-- Sezione Testo -->
            <div class="row text-center" style="background-image: URL(../../Vari/SF211.jpg); background-size: cover; width: 100%; margin-left: 0; color: white; font-size: 25px; height: 100%;">
                ...
                <div class="col-sm-12 col-md-12">
                    ...
                    <Strong>V6 MOTORE</Strong>
                    <br/>
                    <Strong>1600 cm3 CILINDRATA</Strong>
                    <br/>
                    <Strong>4 MJ ENERGIA BATTERIA</Strong> 
                    <br/>
                    <Strong>120 kW POTENZA MGU-K</Strong>
            ...
            <div class="row m-5">
                ...
                <div class="col-sm-12 col-md-4" style="color: red; font-size: 25px;"> 
                    ...
                    <Strong>Power unit 065/6</Strong>
                    ...
                    <p style="color: black; font-size: 18px;">
                        ...
                        <Strong>CILINDRATA 1600 cm3</Strong>
                        <br/>
                        <Strong>REGIME DI ROTAZIONE MASSIMO 15.000</Strong>
                        <br/>
                        <Strong>SOVRALIMENTAZIONE Turbo singolo</Strong>
                        <br/>
                        <Strong>PORTATA BENZINA 100 kg/hr max</Strong>
                        <br/>
                        <Strong>CONFIGURAZIONE V6 90°</Strong>
                        <br/>
                        <Strong>ALESAGGIO 80mm</Strong>
                        <br/>
                        <Strong>CORSA 53mm</Strong>
                        <br/>
                        <Strong>VALVOLE 4 per cilindro</Strong>
                        <br/>
                        <Strong>INIEZIONE Diretta, max 500 bar</Strong>
                ...
                <div class="col-sm-12 col-md-4" style="color: red; font-size: 25px;"> 
                    ...
                    <p style="color: black; font-size: 18px;">
                        <Strong>CONFIGURAZIONE Sistema ibrido di recupero dell’energia attraverso motogeneratori elettrici</Strong>
                        <br/>
                        <Strong>PACCO BATTERIA Batterie in ioni di litio dal peso minimo di 20 kg</Strong>
                        <br/>
                        <Strong>CAPACITÀ MASSIMA PACCO BATTERIE 4MJ</Strong>
                        <br/>
                        <Strong>POTENZA MASSIMA MGU-K 120 kW (161 cv)</Strong>
                        <br/>
                        <Strong>REGIME DI ROTAZIONE MASSIMO MGU-K 50.000</Strong>
                        <br/>
                        <Strong>REGIME DI ROTAZIONE MASSIMO MGU-H 125.000</Strong>
                ...
                <div class="col-sm-12 col-md-4" style="color: red; font-size: 25px;"> 
                    ...
                    <p style="color: black; font-size: 18px;">
                        ...
                        <Strong>PESO COMPLESSIVO CON ACQUA, OLIO E PILOTA 752 KG</Strong>
                        <br/>
                        <Strong>TELAIO IN MATERIALE COMPOSITO A NIDO D’APE IN FIBRA DI CARBONIO CON PROTEZIONE HALO PER L’ABITACOLO</Strong>
                        <br/>
                        <Strong>CARROZZERIA E SEDILE IN FIBRA DI CARBONIO</Strong>
                        <br/>
                        <Strong>DIFFERENZIALE POSTERIORE A CONTROLLO IDRAULICO</Strong>
                        <br/>
                        <Strong>FRENI A DISCO AUTOVENTILANTI IN CARBONIO BREMBO (ANTERIORE E POSTERIORE) E SISTEMA DI CONTROLLO ELETTRONICO SUI FRENI POSTERIORI</Strong>
                        <br/>
                        <Strong>CAMBIO LONGITUDINALE FERRARI A 8 MARCE PIÙ RETRO</Strong>
                        <br/>
                        <Strong>SOSPENSIONI ANTERIORI A PUNTONE (SCHEMA PUSH-ROD). SOSPENSIONI POSTERIORI A TIRANTE (SCHEMA PULL-ROD)</Strong>
                        <br/>
                        <Strong>RUOTE ANTERIORI E POSTERIORI: 13”</Strong>
